# genpark-investment-banking-dcf-lbo-financial-model-builder-skill
...
> **GenPark AI Agent Skill** -- Institutional DCF/LBO financial model and 10-K audit builder (Rogo style)
